...
__wsh_brand_bg="056"
__wsh_brand_fg="015"
__wsh_datetime_bg="141"
__wsh_datetime_fg="000"
__wsh_account_bg="129"
__wsh_account_fg="015"
__wsh_region_bg="183"
__wsh_region_fg="000"
...
function _screen_warn {
    echo -e "$(_screen_encode_color ${__bg_transparent} ${__yellow})WARN: ${__reset}${@}" >&2
}
