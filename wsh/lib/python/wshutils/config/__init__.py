...
from wshutils import clean_up, CONST_WSH_ROOT
...
def _get_config_from_ini_file(f):
    ...
    for config_object in object_list:
        ...
        for attribute in all_attributes:
            ...
            # Replace the WSH_ROOT variable with the current value if present
            value = value.replace('$WSH_ROOT', CONST_WSH_ROOT)
