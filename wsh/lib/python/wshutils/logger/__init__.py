...
class WSHLog(logging.Logger):
    '''Wrapper for consistent logging across various WSH utils'''
    ...
    def __init__(self, context=LOG_CONTEXT, level=_DEFAULT_LOG_LEVEL,
        ...
        WSH_ROOT = os.getenv('WSH_ROOT', '/tmp')
        WSH_LOG_ROOT = os.getenv('HOME', '/tmp')
        log_filename = '{}/.wsh/log/{}.log'.format(WSH_LOG_ROOT, self.context)
